        ...
        btnOperacao.setOnClickListener(
                v -> {
                    ...
                    if (numDestino.isEmpty()) {
                        numeroContaDestino.setError("Número da conta de destino é obrigatório");
                        return;
                    }
                    ...
                    //TODO 12. lembrar de implementar validação dos números das contas e do valor da operação, antes de efetuar a operação de transferência.
